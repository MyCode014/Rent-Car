        ...
        <Row>
          ...
          <Col lg="3" md="4" sm="6">
            <div className="mb-4">
              ...
              <p className="office__info">7731 Trenton St.New York, NY 10023</p>
              <p className="office__info">Phone: +09425562536773</p>

              <p className="office__info">Email: luxurycars@gmail.com</p>
          ...
          <Col lg="12">
            <div className="footer__bottom">
              <p className="section__description d-flex align-items-center justify-content-center gap-1 pt-4">
                <i className="ri-copyright-line"></i>Copyright {year}, Developed by Maja Markovic
